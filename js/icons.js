...
const PATHS = {
  ...
  // author / marketing — recognizable brand silhouettes, still currentColor
  github: '<path class="duo" d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.4 5.4 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.4 5.4 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/>',
  linkedin: '<rect class="duo" x="2" y="2" width="20" height="20" rx="4"/><rect x="2" y="2" width="20" height="20" rx="4"/><circle cx="8" cy="8" r="1.05" fill="currentColor" stroke="none"/><path d="M8 11.2V17.5"/><path d="M12 17.5v-4.4a2.3 2.3 0 0 1 4.6 0v4.4"/>',
  medium: '<ellipse class="duo" cx="6.4" cy="12" rx="4.4" ry="7"/><ellipse cx="6.4" cy="12" rx="4.4" ry="7"/><ellipse cx="13.1" cy="12" rx="2.7" ry="7"/><ellipse cx="18.6" cy="12" rx="1.6" ry="7"/>',
};
