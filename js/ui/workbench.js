...
export function initWorkbench({ catalog, pilot, toast }) {
  ...
  function render() {
    ...
    body.innerHTML = `
      <p>Screen reviewed pilot sources against a research question. Results show evidence and remaining checks; previews are source samples, not live data. A <b>match</b> requires documented overlap — key names alone are never enough. If there is no kit, do not invent a join.</p>
      ${kitNote}
